...
from model import NumberOfMessagesChatParser
...
chat_parser = NumberOfMessagesChatParser()
...
number_of_messages_day_plotter = plotter.NumberOfMessagesDayPlotter(graph_data_creator)
